/*---------------------------------------------------------------------------------------------
 * base : https://github.com/microsoft/vscode/blob/master/src/vs/base/browser/mouseEvent.ts
 *--------------------------------------------------------------------------------------------*/
 ...
 * マウスイベント.
 *
 * VS CodeのmouseEvent.tsから流用.
 *
 * ## オリジナルからの変更箇所
 *
 * * importの削除
 *   * それに伴う修正。
 *   * Windows OS & Safariブラウザの条件を削除。
 *     Electron(chromium)で動作するため削除。
 *
 * @export
